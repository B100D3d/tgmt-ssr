...
export default function snowStorm() {
    ...
    if (typeof window === "undefined") {
      ...
      this.useGPU = true;
      this.className = '___snowStorm___';
    ...
    this.setXY = function(o, x, y) {
      ...
      this.events = (function() {
        ...
        const old = (!window.addEventListener && window.attachEvent), slice = Array.prototype.slice,
        evt = {
      ...
      this.randomizeWind = function() {
        vRndX = plusMinus(rnd(storm.vMaxX,1.5));
        vRndY = rnd(storm.vMaxY,2);
        if (this.flakes) {
      ...
      this.SnowFlake = function(type,x,y) {
        ...
        this.o.style.backgroundImage = `url(${snow})`
